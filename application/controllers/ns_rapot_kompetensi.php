...
Class ns_rapot_kompetensi extends CI_Controller {
...
parent::__construct();
	...
	{
			$data['action']='ns_rapot_kompetensi';
	...
	public function tambah($id='') {
		...
		$data['action']='ns_rapot_kompetensi/tambah_p/'.$id;
	...
	public function tambah_p($id='') {
		...
		if ($result == TRUE) {
			...
			$data['error']="Errorr...";
			redirect('/ns_rapot_kompetensi/tambah/'.$id);
		}
	}
	...
	public function hapus($id) {
		$result = $this->dbx->hapusdata('ns_rapot_kompetensi','replid',$id) ;
		if ($result == TRUE) {
			?><script>
					window.opener.location.reload();
					window.close();
