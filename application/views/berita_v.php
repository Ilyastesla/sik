...
<?php if($view=='index'){ ?>
                <section class="content-header table-responsive">
                    ...
                    <!--
                        ...
                        -->
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('berita/tambah'); ?>'))"><i class="fa fa-plus-square"></i> Tambah</a></li>
                                        ...
                                        <tbody>
											...
											foreach((array)$show_table as $row) {
											    ...
											    echo "<td align='center'>
											    			<a href=javascript:void(window.open('".site_url('berita/view/'.$row->replid)."'))>".$row->subjek."</a>
											    	  </td>";
                          echo "<td align='left'>".$row->tipe."</td>";
                          echo "<td align='left'>".$row->isi_berita."</td>";
											    ...
											    echo "<td align='center'>
											    		<a href=javascript:void(window.open('".site_url('berita/ubah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square'></a>&nbsp;&nbsp;
											    		<a href=javascript:void(window.open('".site_url('berita/hapus/'.$row->replid)."')) class='btn btn-xs btn-danger fa fa-minus-square'></a>
											    		</td>";
											    echo "</tr>";
											}
											?>
            ...
            <section class="content">
		    	...
		    	<table width="100%" border="0">
                  ...
                  <tr>
			        ...
			        <tr>
			            <th align="left">
	                		<label class="control-label" for="minlengthfield">Isi Berita</label>
	                		<div class="control-group">
								<div class="controls">:
			                	</div>
							</div>
			        ...
			        <tr>
			        	<th>
                            <div class='box-body pad'>
                                    <textarea id="editor1" name="isi_berita" rows="10" cols="80" data-rule-required="true">
		            ...
		            <th align="left">
			         ...
			         <tr>
				            <th align="left">
				            	...
				            	<a href="javascript:void(window.open('<?php echo site_url('berita') ?>'))" class="btn btn-success">Batal</a>
				            </th>
				    </tr>
		            </table>
		        	<?php
...
<?php } elseif($view=='tujuan'){ ?>
	    	...
	    	<table width="100%" border="0">
	    		<tr>
	            <th align="left">
	        		<label class="control-label" for="minlengthfield">Subjek Berita</label>
	        		<div class="control-group">
						<div class="controls">:
	                	<?php
	                		echo $isi->subjek;
...
<!--------------------------------------------------------------------------------------------------------------------------->
	            ...
	            <tr>
		            <td align="left">
		            	...
		            	<a href="javascript:void(window.open('<?php echo site_url("berita/ubah/".$id) ?>'))" class="btn btn-warning">Ubah</a>
		            	<a href="javascript:void(window.open('<?php echo site_url('berita/hapus/'.$id) ?>'))" class="btn btn-danger">Hapus</a>
		            </td>
	            </tr>
	            </table>
            </section>
