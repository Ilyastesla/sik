...
<?php if($view=='index'){ ?>
                <section class="content-header table-responsive">
                    ...
                    <!--
                        ...
                        -->
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('inventory_merek/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                              ...
                              foreach((array)$show_table as $rowx) {
                                    ...
                                    echo "<a href=".site_url("inventory_merek/ubah/".$rowx->replid)." class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;&nbsp;";
                                    echo "<a href=".site_url("inventory_merek/hapus/".$rowx->replid)."  class='btn btn-xs btn-danger fa fa-minus-square' ></a>";
                                    echo "</td>";
                                  echo "</tr>";
                              }
                              ?>
