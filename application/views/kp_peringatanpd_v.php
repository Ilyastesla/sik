...
<section class="content">
    <table width="100%" border="0" class="form-horizontal form-validate">
         ...
         <table class="table table-bordered table-striped">
                    <thead>
                          <?php
                            if(($action=="kp_peringatanpd") and ($isi->status<>"4")){ 
                              if(!$isi->onproses){
                                echo "<tr><td colspan=9 align='right'><a href=javascript:void(window.open('".site_url('kp_peringatanpd/tambah2/'.$isi->replid)."'))><i class='fa fa-plus-square'></i> Tambah</a></td></tr>";
                    ...
                    <tbody>
                      ...
                      $CI =& get_instance();$no=1;
                          ...
                          if(($action=="kp_peringatanpd")){
                            ...
                            if(($isi->status<>"4")){ 
                              if(($rowisi2->fase<2)){
                                echo "<a href=javascript:void(window.open('".site_url('kp_peringatanpd/tambah2/'.$rowisi2->idkonseling.'/'.$rowisi2->replid)."')) class='btn btn-xs btn-warning fa fa-minus-square' ></a>&nbsp;&nbsp;";
                              }
                              if(($no==2) and ($rowisi2->sisahari<1)){
                                echo "<a href=javascript:void(window.open('".site_url('kp_peringatanpd/tambaheva/'.$rowisi2->idkonseling.'/'.$rowisi2->replid)."')) class='btn btn-xs btn-danger fa fa-plus-square' ></a>&nbsp;&nbsp;";
                              }
                            }
                            echo "</td>";
                          }
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											foreach((array)$show_table as $row) {
											    ...
											    echo "<td align='center'>".$no++."</td>";
                                                echo "<td align='center'>";
                                                //echo "<a href=javascript:void(window.open('".site_url('kp_peringatanpd/view/0/'.$row->replid)."'))>".strtoupper($row->nis)."</a> ";
