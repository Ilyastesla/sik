...
<?php if($view=='index'){ ?>
                <section class="content-header table-responsive">
                    ...
                    <!--
                        ...
                        -->
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('inventory_fiskal/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                            ...
                            <div class="box">
                              ...
                              foreach((array)$show_table as $rowx) {
                                echo "<tr>";
                                  ...
                                  echo "<a href=".site_url("inventory_fiskal/ubah/".$rowx->replid)." class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;&nbsp;";
                                  echo "<a href=".site_url("inventory_fiskal/hapus/".$rowx->replid)."  class='btn btn-xs btn-danger fa fa-minus-square' ></a>";
                                  echo "</td>";
                                  echo "</tr>";
                              }
                              ?>
...
<?php } elseif($view=='tambah'){ ?>
  ...
  <table width="100%" border="0">
    <tr>
        ...
        <div class="controls">:
                <?php
                  echo form_input(array('class' => '', 'id' => 'kode','name'=>'kode','value'=>$isi->kode,'data-rule-required'=>'true' ,'data-rule-maxlength'=>'200', 'data-rule-minlength'=>'2' ,'placeholder'=>'Masukkan 2-200 Karakter','size'=>'15'));
                ?>
