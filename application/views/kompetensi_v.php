...
<?php if($view=='index'){ ?>
                <section class="content-header table-responsive">
                    ...
                    <!--
                        ...
                        -->
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('kompetensi/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											foreach((array)$show_table as $row) {
											    ...
											    echo "<td align='center'>".strtoupper($row->kompetensi)."</td>";
											    ...
											    echo "<td align='center'>";
													echo "<a href=javascript:void(window.open('".site_url('kompetensi/ubah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;&nbsp;";
													echo "<a href=javascript:void(window.open('".site_url('kompetensi/hapus/'.$row->replid)."')) class='btn btn-xs btn-danger fa fa-minus-square' ></a>";
													echo "</td>";
											    echo "</tr>";
											}
											?>
		    	...
		    	<table width="100%" border="0">
		            ...
		            <th align="left">
	                		...
	                		<div class="control-group">
								<div class="controls">:
			                	<?php
			                		echo form_input(array('class' => '', 'id' => 'kompetensi','name'=>'kompetensi','value'=>$isi->kompetensi,'data-rule-required'=>'true' ,'data-rule-maxlength'=>'100', 'data-rule-minlength'=>'2' ,'placeholder'=>'Masukkan 2-100 Karakter'));
			                	?>
		            ...
		            <th align="left">
			         ...
			         <tr>
				            <th align="left">
				            	...
				            	<a href="javascript:void(window.open('<?php echo site_url('kompetensi') ?>'))" class="btn btn-success">Batal</a>
				            </th>
				    </tr>
		            </table>
		        	<?php
