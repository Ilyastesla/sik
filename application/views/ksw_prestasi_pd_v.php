  ...
  function cetakexcel() {
    ...
    document.getElementById("form").submit();
                ...
                <section class="content-header table-responsive">
                    ...
                    <ol class="breadcrumb">
                            <li><a href="javascript:void(window.open('<?php echo site_url('ksw_prestasi_pd/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                    </ol>
                </section>
                <section class="content-header table-responsive">
                <?php
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											...
											foreach((array)$show_table as $row) {
                                                ...
                                                echo "<td align='center'>";
                                                if($action=="ksw_prestasi_pd"){ 
                                                  if($row->status=="1"){ 
                                                    echo "<a href=javascript:void(window.open('".site_url('ksw_prestasi_pd/tambah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;&nbsp;";
                                                  }
                                                  echo "<a href=javascript:void(window.open('".site_url('ksw_prestasi_pd/view/'.$row->replid)."')) class='btn btn-xs btn-info fa fa-circle-o' ></a>&nbsp;";
                                                }
         ...
         <table border="0">
             <tr align="left">
               <td>
                 <?php
                 if($action=="ksw_prestasi_pd"){ 
                    echo "<a href='".site_url('ksw_prestasi_pd/tambah/'.$isi->replid)."') class='btn btn-warning'>Ubah</a>&nbsp;&nbsp;";
                 }
