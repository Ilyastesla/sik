...
<?php if($view=='index'){ ?>
                ...
                <section class="content-header table-responsive">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('psb_kelompokcalon/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                        <!--
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Departemen</th>
                                                <th>Proses</th>
                                                <th>Program Calon Peserta Didik</th>
                                                <th>Program Siswa</th>
                                                <th>Kapasitas</th>
                                                <th>Lama Proses</th>
                                                <th>Terisi</th>
                          ...
                          echo "<td align=''>".strtoupper($row->prosestext)."</td>";
                          echo "<td align=''>".strtoupper($row->kelompok)."</td>";
                          echo "<td align=''>".strtoupper($row->kelompoksiswatext)."</td>";
                          echo "<td align=''>".strtoupper($row->kapasitas )."</td>";
                          echo "<td align=''>".strtoupper($row->lamaproses)."</td>";
                          echo "<td align=''>".strtoupper($row->jumlah)."</td>";
                          echo "<td align='center'>";
                          echo "<a href=javascript:void(window.open('".site_url('psb_kelompokcalon/ubahaktif/'.$row->replid.'/'.!($row->aktif))."')) >".$CI->p_c->cekaktif($row->aktif)."</a>";
                          //$CI->p_c->cekaktif($row->aktif).
                          echo "</td>";
											    echo "<td align='center'>";
											    		echo "<a href=javascript:void(window.open('".site_url('psb_kelompokcalon/ubah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;&nbsp;";
                          //if ($row->jumlah<1){
											    		echo "<a href=javascript:void(window.open('".site_url('psb_kelompokcalon/hapus/'.$row->replid)."')) class='btn btn-xs btn-danger fa fa-minus-square' ></a> ";
                          //}
											    echo "</td>";
											    echo "</tr>";
											}
...
<section class="content-header table-responsive">
          ...
          <tr>
              ...
              <div class="controls">:
                  <?php
                    $arrkelompok_siswa="id='kelompok_siswa' data-rule-required=true";
          ...
          <tr>
	            <th align="left">
                		<label class="control-label" for="minlengthfield">Program Calon Peserta Didik</label>
                		<div class="control-group">
							<div class="controls">:
                      <?php
            ...
            <tr>
				            <th align="left">
		                		<label class="control-label" for="minlengthfield">Lama Proses</label>
		                		<div class="control-group">
									<div class="controls">:
				                	<?php
				                		echo form_input(array('id' => 'lamaproses','name'=>'lamaproses','value'=>$isi->lamaproses,'data-rule-required'=>'true' ,'data-rule-maxlength'=>'3', 'data-rule-minlength'=>'1','data-rule-number'=>'true','placeholder'=>'Masukkan 1-3 Karakter'));
				                	?>
				                	<?php //echo  <p id="message"></p> ?>
									</div>
		                		</div>
				    ...
				    <tr>
				            <th align="left">
				            	...
				            	<a href="javascript:void(window.open('<?php echo site_url("psb_kelompokcalon") ?>'))" class="btn btn-success">Kembali</a>
				            </th>
				    </tr>
		            </table>
		        	<?php
