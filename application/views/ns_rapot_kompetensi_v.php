...
<?php if($view=='index'){ ?>
              ...
              <th align="left">
                ...
                <th align="left">
                              ...
                              <div class="controls">:
                                      <?php
                                        $arridmatpel="data-rule-required=false id=idmatpel  onchange=javascript:this.form.submit();";
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                          ...
                          echo "<td align='center'>".$row->kompetensitext."</td>";
                          ...
                          echo "<a href=javascript:void(window.open('".site_url($action.'/tambah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;";
                          echo "<a href=javascript:void(window.open('".site_url($action.'/hapus/'.$row->replid)."')) class='btn btn-xs btn-danger fa fa-minus-square' ></a> ";
