...
<?php if($view=='index'){ ?>
                <section class="content-header table-responsive">
                    ...
                    <!--
                        ...
                        -->
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('hrm_pegawai_daily_set/tambah'); ?>'))"><i class="fa fa-plus-square"></i> Tambah</a></li>
                                ...
                                <div class="box-body table-responsive">
                                    <table class="table table-bordered table-striped">
                                      <thead>
                                          <tr>
                                              <?php
                                              echo "<th width='130'>Periode</th>";
                                              echo "<th width='50'>Durasi</th>";
                                              echo "<th>Kegiatan</th>";
                                              //echo "<th>Deskripsi</th>";
                                              echo "<th width='200'>Projek</th>";
                                              echo "<th width='80'>Aktif</th>";
                                      ...
                                      foreach((array)$show_table as $row) {
                											    echo "<tr>";
                                          echo "<td align='center'>".$row->jammulai." - ".$row->jamakhir."</td>";
                                          echo "<td align='center'>".$row->durasi."</td>";
                                          echo "<td align='left' valign='top'><b>".$row->kegiatantipetext."</b><br/>".$row->kegiatan."</td>";
                                          ...
                                          echo "<td align='center'>";
                                          if($row->pakai<1){
                                            echo "<a href=javascript:void(window.open('".site_url('hrm_pegawai_daily_set/ubah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square'></a>&nbsp;&nbsp;";
                                            echo "<a href=javascript:void(window.open('".site_url('hrm_pegawai_daily_set/hapus/'.$row->replid)."')) class='btn btn-xs btn-danger fa fa-minus-square'></a>&nbsp;&nbsp;";
                                          }
                                          echo "</td>";
                											    echo "</tr>";
                											}
    ...
    $("#jamakhirminute").change(function(){
      ...
      document.getElementById("durasiminute").value='00';
            ...
            <tr>
             ...
             <div class="controls">:
                     <?php
                       $arridkegiatantipe='data-rule-required=true';
            ...
            <tr>
             ...
             <div class="controls">:
                     <?php
                       $arridprojektask='data-rule-required=false';
            ...
            <tr>
		            <th align="left">
	                		...
	                		<div class="control-group">
								<div class="controls">:
                        <textarea name="kegiatan"><?php echo $isi->kegiatan ?></textarea>
                        <?php
			                	...
			                	?>
                        <input type='hidden' name='tanggal' value='<?php echo $CI->p_c->tgl_form($isi->tanggal); ?>'>
			                	<?php //echo  <p id="message"></p> ?>
								</div>
	                		</div>
			            </th></tr>
              ...
              -->
			         <tr>
				            <th align="left">
				            	...
				            	<a href="javascript:void(window.open('<?php echo site_url('hrm_pegawai_daily_set') ?>'))" class="btn btn-success">Batal</a>
				            </th>
				    </tr>
		            </table>
		        	<?php
