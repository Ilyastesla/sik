...
<!------------------------------------------------------------------------------------------------------------------------------------->
                            ...
                            <?php }
														if($view2<>1){?>
																<section class="content-header" align="right">
																		<ol class="breadcrumb">
																				<li><a href="javascript:void(window.open('<?php echo site_url('uudp/tambahlain/'.$id); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
																		</ol>
																</section>
														<? }
			                ...
			                <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                	...
                                	$no=1;
                                	if (!empty($lpjlain)){
																		foreach($lpjlain as $rowlpjlain) {
																			//echo var_dump($rowlpjlain);
																			$jml_lain_realisasi=$jml_lain_realisasi+$rowlpjlain->nilaitot;
																		    echo "<tr>";
																		    echo "<td align='center'>".$no++."</td>";
																				echo "<td align=''>".$rowlpjlain->idsumberdanatext."</td>";
																		    echo "<td align=''>".$rowlpjlain->idpengeluarantext."</td>";
																				echo "<td align=''>".$rowlpjlain->coa."</td>";
																		    echo "<td align='center'>".$CI->p_c->rupiah($rowlpjlain->nilaitot)."</td>";
																				echo "<td align='center'>".$CI->p_c->tgl_indo($rowlain->tanggalrealisasi)."</td>";
																				echo "<td align='center'>".$rowlpjlain->keterangan."</td>";
																		    if($view2<>1){
																		    echo "<td align='center'>";
																		    echo "
		...
		<section class="content-header table-responsive">
            ...
            <section class="content">
		    	...
		    	<table width="100%" border="0">
			    	 <tr>
				            <th align="left">
		                		<label class="control-label" for="minlengthfield">Realisasi</label>
		                		<div class="control-group">
									<div class="controls" valign="top">&nbsp;&nbsp;
				                	<?php
