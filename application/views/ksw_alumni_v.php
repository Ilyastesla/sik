...
<?php if($view=='index'){ ?>
                ...
                <section class="content-header table-responsive">
                    ...
                    <!--
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('ksw_alumni/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                          <tr>
                                              ...
                                              ?><td width="50" align='center'><input type="checkbox" onClick="selectallx('idsiswa','selectall')" id="selectall" class="selectall"/></td>
                          ...
                          echo "</td>";
                                    ...
                                    <tr>
                                          ...
                                          <input type='hidden' name='idkelas' value='<?php echo $this->input->post('idkelas') ?>'>
                     				            	<?php
                                              echo "Tanggal Lulus : ";
                                              echo form_input(array('class' => '', 'id' => 'dp1','name'=>'tgllulus','value'=>$CI->p_c->tgl_form($hariini),'data-rule-required'=>'true' ,'data-rule-maxlength'=>'100', 'data-rule-minlength'=>'2' ,'placeholder'=>'DD-MM-YYYY','autocomplete'=>'off'));
                          ...
                          echo "<td align='center'>".$CI->p_c->cekaktif($row->aktif)."</td>";
                          echo "<td align='center'>";
                          echo "<a href=javascript:void(window.open('".site_url('ksw_alumni/hapus/'.$row->replid)."')) class='btn btn-danger' >Hapus</a>";
                          echo "</td>";
											    echo "</tr>";
											}
											?>
