...
<?php if($view=='index'){ ?>
                ...
                <section class="content-header table-responsive">
                    ...
                    <!--
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('psb_caricalonsiswa/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                          ...
                          echo "</td>";
                          echo "<td align='center'>".strtoupper($row->nisn)."</td>";
                          ...
                          echo "<td align='center'>".($CI->p_c->tgl_indo($row->tanggal_daftar)).'<br/>('.$row->tahunmasuk.")</td>";
                          ...
                          //echo "<td align='center'>";
											    //echo "<a href=javascript:void(window.open('".site_url('psb_caricalonsiswa/ubah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;&nbsp;";
											    //echo "</td>";
											    echo "</tr>";
											}
											?>
