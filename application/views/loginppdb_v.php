        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
									<?php if ($this->session->flashdata('errorloginppdb')<>"") { ?>
						      <div class="alert alert-danger alert-dismissable" align="left">
						              <i class="fa fa-ban"></i>
						              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
						              <b>Alert!</b> <?php echo $this->session->flashdata('errorloginppdb') ?>..
						          </div>
						      <?php } ?>
                    <?php $CI =& get_instance();?>
	                <?php
	                ...
	                <table width="100%" border="0">
			            ...
			            <th align="left">
	                		...
	                		<div class="control-group">
								<div class="controls">:
			                	<?php
			                		echo form_input(array('class' => '', 'id' => 'username','name'=>'username','value'=>"",'data-rule-required'=>'true' ,'data-rule-maxlength'=>'15', 'data-rule-minlength'=>'14' ,'placeholder'=>'Masukkan 15 Karakter'));
			                	?>
                  ...
                  <tr>
			            <th align="left">
	                		...
	                		<div class="control-group">
								<div class="controls">:
			                	<?php
			                		echo form_input(array('class' => '', 'id' => 'token','name'=>'token','value'=>"",'data-rule-required'=>'true' ,'data-rule-maxlength'=>'8', 'data-rule-minlength'=>'8' ,'placeholder'=>'Masukkan 8 Karakter'));
			                	?>
			                	<?php //echo  <p id="message"></p> ?>
								</div>
	                		</div>
			            ...
			            <th align="left">
	                		...
	                		<div class="control-group">
								<div class="controls">:
                        <?php
                              //echo $this->session->userdata('captchaproses');
                              echo $captcha;
                        ?>
			                	<?php //echo  <p id="message"></p> ?>
								</div>
