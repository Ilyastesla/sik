...
<?php if($view=='index'){ ?>
                ...
                <section class="content-header table-responsive">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('ksw_tingkat/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                        <!--
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                          ...
                          echo "<a href=javascript:void(window.open('".site_url('ksw_tingkat/ubahaktif/'.$row->replid.'/'.!($row->aktif))."')) >".$CI->p_c->cekaktif($row->aktif)."</a>";
                          //$CI->p_c->cekaktif($row->aktif).
                          echo "</td>";
											    echo "<td align='center'>";
											    		echo "<a href=javascript:void(window.open('".site_url('ksw_tingkat/ubah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;&nbsp;";
                          if ($row->pakai<1){
											    		echo "<a href=javascript:void(window.open('".site_url('ksw_tingkat/hapus/'.$row->replid)."')) class='btn btn-xs btn-danger fa fa-minus-square' ></a> ";
                          }
											    echo "</td>";
											    echo "</tr>";
											}
...
<section class="content-header table-responsive">
          ...
          <tr>
            <th align="left">
            <label class="control-label" for="minlengthfield">Kesetaraan</label>
            <div class="control-group">
          <div class="controls">:
            <?php
              $arridkesetaraan='data-rule-required=true';
              echo form_dropdown('idkesetaraan',$idkesetaraan_opt,$isi->idkesetaraan,$arridkesetaraan);
            ?>
                  <?php //echo  <p id="message"></p> ?>
          </div>
            </div>
				    ...
				    <tr>
				            <th align="left">
				            	...
				            	<a href="javascript:void(window.open('<?php echo site_url("ksw_tingkat") ?>'))" class="btn btn-success">Kembali</a>
				            </th>
				    </tr>
		            </table>
		        	<?php
