...
<?php if($view=='index'){ ?>
                <section class="content-header table-responsive">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('ppkb_cek/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                        <!--
                                        ...
                                        <tbody>
											...
											foreach((array)$show_table as $row) {
											    ...
											    echo "<td align='center'>
											    			<a href=javascript:void(window.open('".site_url('ppkb_cek/view/'.$row->replid)."'))>".$row->kode_transaksi."</a>
											    	  </td>";
											    ...
											    echo "<a href=javascript:void(window.open('".site_url('ppkb_cek/ubah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;&nbsp;";
													echo "<a href=javascript:void(window.open('".site_url('ppkb_cek/hapus/'.$row->replid)."')) class='btn btn-xs btn-danger fa fa-minus-square' ></a>";
											    }//else{
		    	...
		    	<table width="100%" border="0">
				    ...
				    <tr>
				            <th align="left">
				            	...
				            	<a href="javascript:void(window.open('<?php echo site_url('ppkb_cek') ?>'))" class="btn btn-success">Batal</a>
				            </th>
				    </tr>
		            </table>
		        	<?php
				     ...
				     <tr>
				     	<td align="left">
				     		...
				     		<section class="content-header" align="right">
			                    <ol class="breadcrumb">
			                        <li><a href="javascript:void(window.open('<?php echo site_url('ppkb_cek/tambahlain/'.$id); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
			                    </ol>
			                </section>
                                ...
                                <tbody>
                                	...
                                	if (!empty($lain)){
										foreach($lain as $rowlain) {
										    ...
										    echo "<td align='center'>";
										    echo "
										    		<a href=javascript:void(window.open('".site_url('ppkb_cek/tambahlain/'.$isi->replid.'/'.$rowlain->replid)."')) class='btn btn-xs btn-warning'>
										    			Ubah
										    		</a>
										    		<a href=javascript:void(window.open('".site_url('ppkb_cek/hapuslain/'.$isi->replid.'/'.$rowlain->replid)."')) class='btn btn-xs btn-danger'>
										    			Hapus
										    		</a>";
										    echo "</td>";
										    echo "</tr>";
                            ...
                            <hr><h4>Termin Pembayaran :</h4>
				     		<section class="content-header" align="right">
			                    <ol class="breadcrumb">
			                        <li><a href="javascript:void(window.open('<?php echo site_url('ppkb_cek/tambahtermin/'.$id); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
			                    </ol>
			                </section>
             				<table class="table table-bordered table-striped">
                                <thead>
                                ...
                                <tbody>
                                	...
                                	if (!empty($termin)){
										foreach($termin as $row) {
										    ...
										    echo "<td align='center'>";
										    echo "
										    		<a href=javascript:void(window.open('".site_url('ppkb_cek/tambahtermin/'.$isi->replid.'/'.$row->replid)."')) class='btn btn-xs btn-warning'>
										    			Ubah
										    		</a>
										    		<a href=javascript:void(window.open('".site_url('ppkb_cek/hapustermin/'.$isi->replid.'/'.$row->replid)."')) class='btn btn-xs btn-danger'>
										    			Hapus
										    		</a>";
										    echo "</td>";
										    echo "</tr>";
                            ...
                            <?php
				        	 ...
				        	 echo form_open_multipart('ppkb_cek/upload_it/'.$id,$attributes);
				        	?>
				        	<div align="left">
				        	...
				        	<table class="table table-bordered table-striped">
			                    ...
			                    <tbody>
									...
									foreach((array)$attachment as $row2) {
									    ...
									    echo "<td>";
									    echo "<a href=javascript:void(window.open('".site_url('ppkb_cek/hapus_attachment/'.$row2->replid.'/'.$row2->newfile).'/'.$id."')) class='btn btn-danger' id='btnOpenDialog'>Hapus</a>";
									    echo "</td>";
									    echo "</tr>";
									}
									?>
		    	...
		    	<table width="100%" border="0">
			    	 <tr>
				        ...
				        <tr>
				            <th align="left">
				            	<button class='btn btn-primary' onclick="return validate()">Simpan</button>
				            	<a href="javascript:void(window.open('<?php echo site_url('ppkb_cek/material/'.$idx) ?>'))" class="btn btn-success">Batal</a>
				            </th>
				    </tr>
	            </table>
	        	<?php
                                ...
                                <tbody>
                                	...
                                	if (!empty($uudp)){
										foreach($uudp as $rowuudp) {
										    ...
										    echo "<td align='center'>";
											   ?><a href="JavaScript:cetakuudp('<?=$rowuudp->idppkb_cek?>','<?=$rowuudp->replid?>')" class="fa fa-file-text">&nbsp;&nbsp;Cetak</a><?php
											echo "</td>";
										    echo "</tr>";
										}
									}
