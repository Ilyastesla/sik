                ...
                <section class="content">
			            ...
			            <th align="left">
			        		...
			        		<div class="control-group">
			                	...
			                	<select name="berdasarkan" data-rule-required="false">
									...
									<option value="kk.jumlah">Jumlah</option>
		            ...
		            <tr>
			            <td colspan="2" align="left">
				            ...
				            <a href="javascript:void(window.open('<?php echo site_url('ppkb_report') ?>'))" class="btn btn-success">Kembali</a>
			            </td>
		            </tr>
                    </table>
                                    ...
                                    <table class="table table-bordered table-striped" style="width:100% !important;font-size:9px !important;">
                                        <thead>
                                            <tr>
                                                <th rowspan="2">No.</th>
                                        ...
                                        <tbody>
											...
											foreach((array)$show_table as $row) {
											    ...
											    if ($replidkk<>$replidkk2){
												    ...
												    echo "<td align='center'>
												    			<a href=javascript:void(window.open('".site_url('ppkb/view/'.$row->replid)."' >".$row->kode_transaksi."</a>"."<br/>".strtoupper($row->statustext)."</td>";
											...
											echo "<tr>";
											echo "<th style='text-align:right;' colspan='9'>JUMLAH :</th>";
											...
											echo "</tr>";
											echo "<tr>";
											echo "<th style='text-align:right;' colspan='9'>SISA LPJ :</th>";
