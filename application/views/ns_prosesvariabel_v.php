...
<?php if($view=='index'){ ?>
                ...
                <section class="content-header table-responsive">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('ns_prosesvariabel/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                        <!--
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                          ...
                          echo "<td align=''>".strtoupper($row->iddepartemen)."</td>";
                            ...
                            if ($row->pakai<1){
  											    		echo "<a href=javascript:void(window.open('".site_url('ns_prosesvariabel/ubah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;&nbsp;";
  											    		echo "<a href=javascript:void(window.open('".site_url('ns_prosesvariabel/hapus/'.$row->replid)."')) class='btn btn-xs btn-danger fa fa-minus-square' ></a>";
                            }
											    echo "</td>";
											    echo "</tr>";
											}
...
<section class="content-header table-responsive">
            ...
            <section class="content">
		    	...
		    	<table width="100%" border="0">
		    		<tr>
		            <th align="left">
	                		<label class="control-label" for="minlengthfield">Variabel Proses Siswa</label>
	                		<div class="control-group">
								<div class="controls">:
			                	<?php
			                		echo form_input(array('class' => '','style'=>'margin: 0px 0px 5px; width: 687px;', 'id' => 'prosesvariabel','name'=>'prosesvariabel','value'=>$isi->prosesvariabel,'data-rule-required'=>'true' ,'data-rule-maxlength'=>'500', 'data-rule-minlength'=>'2' ,'placeholder'=>'Masukkan 5-100 Karakter'));
			                	?>
			                	<?php //echo  <p id="message"></p> ?>
								</div>
	                		</div>
			        ...
			        <tr>
		            <th align="left">
		        		<label class="control-label" for="minlengthfield">Proses Siswa</label>
		        		<div class="control-group">
							<div class="controls">:
		                	<?php
		                		$arridprosestipe='data-rule-required=true';
				    ...
				    <tr>
				            <th align="left">
				            	...
				            	<a href="javascript:void(window.open('<?php echo site_url("ns_prosesvariabel") ?>'))" class="btn btn-success">Kembali</a>
				            </th>
				    </tr>
		            </table>
		        	<?php
