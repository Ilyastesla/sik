...
<?php if($view=='index'){ ?>
                <section class="content-header table-responsive">
                    ...
                    <!--
                        ...
                        -->
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('pegawai_status/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                          ...
                          echo "<td align='center'>".strtoupper($row->type)."</td>";
											    ...
											    echo "<td align='center'><a href=javascript:void(window.open('".site_url('pegawai_status/ubah/'.$row->replid)."')) class='btn btn-xs btn-warning fa fa-check-square' ></a>&nbsp;&nbsp;";
													echo "<a href=javascript:void(window.open('".site_url('pegawai_status/hapus/'.$row->replid)."')) class='btn btn-xs btn-danger fa fa-minus-square' ></a>";
													echo "</td>";
											    echo "</tr>";
											}
											?>
		            ...
		            <th align="left">
			         ...
			         <tr>
				            <th align="left">
				            	...
				            	<a href="javascript:void(window.open('<?php echo site_url('pegawai_status') ?>'))" class="btn btn-success">Batal</a>
				            </th>
				    </tr>
		            </table>
		        	<?php
