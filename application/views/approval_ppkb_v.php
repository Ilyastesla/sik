                                        ...
                                        <tbody>
											...
											foreach((array)$show_table as $row) {
											    ...
											    echo "<td align='center'>
											    			<a href=javascript:void(window.open('".site_url('approval_ppkb/view/'.$row->replid)."'))>".$row->kode_transaksi."</a>
											    	  </td>";
											    ...
											    echo "<td align='center'>";
											    echo "
											    		<a href=javascript:void(window.open('".site_url('approval_ppkb/view/'.$row->replid)."'))>
	                            ...
	                            <tr>
							            ...
							            if ($isi->next_approver==$this->session->userdata('idpegawai')){
							        		...
							        		<div class="control-group">
							        			...
							        			<button class='btn btn-primary'>Persetujuan</button>
							        			<?php
								        			echo "<a href=javascript:void(window.open('".site_url('approval_ppkb/reject/'.$isi->replid.'/'.$isi->status)."')) class='btn btn-xs btn-danger'>Tolak</a> ";
								        	}

								       }//next_approver ?>
							            	<a href="javascript:void(window.open('<?php echo site_url('approval_ppkb') ?>'))" class="btn btn-success">Batal</a>
							            </th>
							    </tr>
					            </table>
                            </table>
