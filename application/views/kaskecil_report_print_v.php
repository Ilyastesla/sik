...
<body>	
	<table border="0"> 
		<tr>
			<th colspan="18" align="center"><h1><?php echo $form ?></h1></th>
		</tr>
		<tr>
			<td colspan="18" align="left"><h3>:: Filter</h3></th>
		</tr>
		<?php
		...
		<table <?php echo $style ?> border="1">
				...
				foreach((array)$show_table as $row) {
				    ...
				    if ($replidkk<>$replidkk2){
					    echo "<td align='' valign='top'>".strtoupper($no++)."</td>";
					    echo "<td align='center' valign='top'>".$row->kode_transaksi."</td>";
					    echo "<td align='center' valign='top'>".$row->noppkb."</td>";
					    echo "<td align='' valign='top'>".strtoupper($row->company)."</td>";
					    echo "<td align='' valign='top'>".strtoupper($row->departemen)."</td>";
					    echo "<td align='center' valign='top'>".strtoupper($row->pemohontext)."</td>";
					    echo "<td align='center' valign='top'>".strtoupper($CI->p_c->tgl_indo($row->tanggalpengajuan))."</td>";
					    echo "<td align='center' valign='top'>".strtoupper($row->approvebytext)."</td>";
					    echo "<td align='center' valign='top'>".strtoupper($CI->p_c->tgl_indo($row->approve_date))."</td>";
					    echo "<td align='center' valign='top'>".strtoupper($row->penerimatext)."</td>";
					    echo "<td align='center' valign='top'>".strtoupper($CI->p_c->tgl_indo($row->tanggalpenerima))."</td>";
					    echo "<td align='' valign='top'>".strtoupper($row->statustext)."</td>";
					}else{
					   echo "<td align='' colspan='12'>&nbsp;</td>"; 
				    }
				    echo "<td valign='top'>".strtoupper($row->idpengeluaran)."</td>";
				    echo "<td valign='top'>".strtoupper($row->idkredit)."</td>";
				    echo "<td valign='top'>".strtoupper($row->iddebit)."</td>";
				    echo "<td valign='top'>".strtoupper($row->keperluan)."</td>";
				    echo "<td align='right' valign='top'>".$CI->p_c->rupiah($row->jumlahmat)."</td>";
				    echo "<td align='center' valign='top'>".strtoupper($CI->p_c->tgl_indo($row->tanggalrealisasi))."</td>";
				    echo "<td align='right' valign='top'>".$CI->p_c->rupiah($reals)."</td>";
				    echo "</tr>";
				...
				echo "<th style='text-align:right;' colspan='16'>NILAI TOTAL :</th>";
				...
				echo "</tr>";
				echo "<tr bgcolor='#f3f4f5'>";
				echo "<th style='text-align:right;' colspan='16'>BELUM REALISASI :</th>";
