...
<?php if($view=='index'){ ?>
                ...
                <section class="content-header table-responsive">
                    ...
                    <!--
                    <ol class="breadcrumb">
                        <li><a href="javascript:void(window.open('<?php echo site_url('ksw_pindahkelas/tambah'); ?>'))" ><i class="fa fa-plus-square"></i> Tambah</a></li>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                          ...
                          echo "<td align='center'>".$CI->p_c->cekaktif($row->aktif)."</td>";
                          echo "<td align='center'>";
                          echo "<a href=javascript:void(window.open('".site_url('ksw_pindahkelas/hapus/'.$row->replid)."')) class='btn btn-danger' >Hapus</a>";
                          echo "</td>";
											    echo "</tr>";
											}
											?>
