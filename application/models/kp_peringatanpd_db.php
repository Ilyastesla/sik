...
Class kp_peringatanpd_db extends CI_Model {
    ...
    public function data() {
		...
		$cari=$cari." AND ta.departemen='".$this->input->post('iddepartemen')."' ";
                ...
                $sql = "SELECT r.*,s.nis,s.nama as namasiswatext,s.abk,s.aktif as aktifsiswa
                                ...
                                ,ke.nama as katevaltext
                                ,st.status as statustext
                                
                        FROM kp_konseling r
                        INNER JOIN kp_konselingreport kr ON kr.idkonseling=r.replid
                        ...
                        LEFT JOIN reff_konseling ke ON ke.replid=kr.idkategorievaluasi  
                        LEFT JOIN hrm_status st ON st.node=r.status 
                        WHERE kr.idkategorievaluasi='21' ".$cari." ".$cari2." ".$cari3." ".$order;
                //echo $sql;die;
