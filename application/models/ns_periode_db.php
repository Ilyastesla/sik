...
Class ns_periode_db extends CI_Model {
    ...
    public function data() {
      	...
      	$sql="SELECT * FROM ns_periode ORDER BY periode";
   ...
   public function tambah_pdb($data) {
    	...
    	$this->db->trans_start();
        $this->db->insert('ns_periode', $data);
     ...
     public function ubah_pdb($data,$id) {
        ...
        $this->db->update('ns_periode', $data);
